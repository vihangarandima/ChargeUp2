  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.rightControls}>
        <TouchableOpacity style={styles.controlBtn} onPress={() => console.log("Directions pressed")}>
          <Ionicons name="navigate" size={22} color="#007AFF" style={{ transform: [{ rotate: "45deg" }] }} />
        </TouchableOpacity>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          ...
          {stations.length === 0 && (
             <View style={styles.stationCard}>
                ...
                <Text style={styles.cardDistance}>Try expanding your search.</Text>
             </View>
          )}
        </ScrollView>
      </View>
