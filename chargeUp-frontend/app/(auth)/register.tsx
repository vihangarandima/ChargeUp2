          ...
          >
            <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
              ...
              <View style={styles.legalBox}>
                <Ionicons name="shield-checkmark-outline" size={14} color="#5ECFDA" style={{ marginRight: 8 }} />
...
const styles = StyleSheet.create({
  ...
  blob1: { position: "absolute", width: 300, height: 300, borderRadius: 150, backgroundColor: "rgba(94,207,218,0.06)", top: -100, right: -80 },
  ...
  badgePill: { flexDirection: "row", alignItems: "center", backgroundColor: "rgba(94,207,218,0.1)", borderRadius: 20, paddingHorizontal: 10, paddingVertical: 4, gap: 5 },
  ...
  heroTitle: { color: "white", fontSize: 28, fontWeight: "800", marginBottom: 5 },
  ...
  inputWrap: { flexDirection: "row", alignItems: "center", backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", paddingHorizontal: 15, paddingVertical: 12 },
  inputWrapFocused: { backgroundColor: "rgba(94,207,218,0.08)", borderColor: "rgba(94,207,218,0.4)" },
  inputIconBox: { width: 24 },
  inputBody: { flex: 1, minHeight: 45, justifyContent: 'center' },
  floatLabel: { color: "rgba(255,255,255,0.3)", fontSize: 10, fontWeight: "700", textTransform: "uppercase", marginBottom: 2 },
  ...
  ctaArrow: { width: 28, height: 28, borderRadius: 14, backgroundColor: "white", alignItems: "center", justifyContent: "center" },
  ...
  socialBtn: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, paddingVertical: 14, borderRadius: 14, backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1, borderColor: "rgba(255,255,255,0.1)" },
  googleBtn: { backgroundColor: "rgba(234,67,53,0.06)", borderColor: "rgba(234,67,53,0.2)" },
  ...
  legalBox: { flexDirection: "row", alignItems: "center", backgroundColor: "rgba(94,207,218,0.05)", borderRadius: 12, padding: 12 },
  legalText: { flex: 1, color: "rgba(255,255,255,0.5)", fontSize: 11, lineHeight: 16 },
  legalLink: { color: "#5ECFDA", fontWeight: "600", textDecorationLine: 'underline' }
});