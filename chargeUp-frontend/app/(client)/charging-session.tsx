...
export default function ChargingSession() {
  ...
  // 1. Get variables passed from the previous screen
  ...
  const handleStopCharging = async () => {
    // 🔥 FIX: Removed the Rs. 10.00 minimum. Now it sends the EXACT live amount!
    ...
    // Move to payment page with the EXACT live amount
    router.push({
      pathname: '/payment', 
...
const styles = StyleSheet.create({
  ...
  controlRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 5, marginBottom: 35 },
  ...
  payButton: { marginTop: 15, alignSelf: 'center', borderWidth: 1, borderColor: '#FFFFFF', backgroundColor: 'transparent', borderRadius: 30, paddingVertical: 12, paddingHorizontal: 60, alignItems: 'center' },
