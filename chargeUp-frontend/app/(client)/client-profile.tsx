...
export default function ProfileScreen() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      desc: isHost ? "View and manage your stations" : "Share your charger & earn money",
      color: "#FFC850",
      onPress: () => {},
    },
    {
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
            ...
            <Animated.View style={[styles.identityBlock, { transform: [{ scale: avatarScale }] }]}>
              ...
              <Pressable style={styles.editAvatarBtn} onPress={handlePickPhoto}>
              ...
              <View style={[styles.roleChip, isHost && styles.roleChipGold]}>
                ...
                />
                <Text style={[styles.roleChipText, isHost && { color: "#FFC850" }]}>
              ...
              {[
                ...
                <React.Fragment key={i}>
                  ...
                  <View style={styles.statItem}>
                    <Ionicons name={s.icon as any} size={14} color="#5ECFDA" style={{ marginBottom: 4 }} />
              ...
              {menuItems.map((item, index) => (
                ...
                >
                  ...
                  <View style={styles.menuTextWrap}>
                    <Text style={[styles.menuLabel, (item as any).danger && { color: "#FF6B6B" }]}>{item.label}</Text>
...
const styles = StyleSheet.create({
  ...
  topAccent: { position: "absolute", top: 0, left: 0, right: 0, height: 2, backgroundColor: "#5ECFDA", opacity: 0.7, zIndex: 10 },
  evBgContainer: { position: "absolute", top: -height * 0.1, left: -width * 0.08, width: width * 1.16, height: height * 0.52, zIndex: 0 },
  carGlow: { position: "absolute", bottom: -8, left: "5%", width: "90%", height: 40, borderRadius: 60, backgroundColor: "#5ECFDA", shadowColor: "#5ECFDA", shadowOpacity: 1, shadowRadius: 32, elevation: 14 },
  topBar: { flexDirection: "row", alignItems: "center", marginTop: 8, zIndex: 5 },
  logoChip: { width: 26, height: 26, borderRadius: 7, backgroundColor: "#5ECFDA", alignItems: "center", justifyContent: "center", marginRight: 8 },
  ...
  avatarRing: { width: 150, height: 150, borderRadius: 75, borderWidth: 4, borderColor: "rgba(94,207,218,0.6)", padding: 4, marginBottom: 4, elevation: 16 },
  ...
  editAvatarBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: "#5ECFDA", borderWidth: 2, borderColor: "rgba(255,255,255,0.3)", alignItems: "center", justifyContent: "center", marginTop: -18, marginBottom: 14, zIndex: 10, shadowColor: "#5ECFDA", shadowOpacity: 0.6, shadowRadius: 8, elevation: 8 },
  profileName: { color: "white", fontSize: 26, fontWeight: "800", marginBottom: 10 },
  roleChip: { flexDirection: "row", alignItems: "center", gap: 6, backgroundColor: "rgba(94,207,218,0.12)", borderWidth: 1, borderColor: "rgba(94,207,218,0.3)", borderRadius: 20, paddingHorizontal: 14, paddingVertical: 5, marginBottom: 14 },
  ...
  statsRow: { flexDirection: "row", backgroundColor: "rgba(255,255,255,0.04)", borderWidth: 1, borderColor: "rgba(94,207,218,0.14)", borderRadius: 20, paddingVertical: 16, marginBottom: 28 },
  ...
  sectionTitle: { color: "rgba(255,255,255,0.35)", fontSize: 11, fontWeight: "700", textTransform: "uppercase" },
  menuList: { gap: 10, marginBottom: 30 },
  menuItem: { flexDirection: "row", alignItems: "center", backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 18, borderWidth: 1, borderColor: "rgba(255,255,255,0.07)", paddingHorizontal: 14, paddingVertical: 13, gap: 13 },
